...
class MorphingAnimation {
    ...
    private com.spisoft.sprogressbutton.OnAnimationEndListener mListener;
    ...
    private com.spisoft.sprogressbutton.StrokeGradientDrawable mDrawable;

    public MorphingAnimation(TextView viewGroup, com.spisoft.sprogressbutton.StrokeGradientDrawable drawable) {
        mView = viewGroup;
        mDrawable = drawable;
    }
    ...
    public void setListener(com.spisoft.sprogressbutton.OnAnimationEndListener listener) {
        mListener = listener;
    }
